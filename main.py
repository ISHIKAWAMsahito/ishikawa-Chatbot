...
async def serve_admin():
    ...
    if not os.path.exists(file_path): 
        raise HTTPException(status_code=404, detail=f"admin.html not found at path: {file_path}")
    return FileResponse(file_path)
