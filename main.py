...
KEYWORD_MAP = {
    ...
    "施設": [
        ...
        "サブアリーナ", "上靴", "江別キャンパス", "新札幌キャンパス", "C館","施設","故障","破損","器物","F館","学生館","体育センター","SGUホール","50年記念館","用具","体育センター","陸上競技場","テニスコート","バスケットコート","バレーコート","フットサルコート","多目的グランド","野 球 場","室内練習場","多目的グランド","ランニングロード","弓 道 場","洋 弓 場","合宿","ラウンジ"
        # 俗語・略語
