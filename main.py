...
# キーワードマッピング
KEYWORD_MAP = {
    "授業": ["学事暦", "シラバス", "授業計画", "年間スケジュール", "夏休み", "冬休み", "春休み", "夏季休業", "冬季休業", "春季休業", "授業時間", "90分", "講時", "補講", "休講", "情報ポータル"],
    
    "欠席手続き": ["忌引き", "休む", "欠席", "休講", "病気", "インフルエンザ", "欠席届", "公認欠席", "特別欠席", "感染症", "教育実習", "クラブ", "公式大会", "学校保健安全法"],
    
    "試験": ["試験", "テスト", "追試", "再試", "成績", "レポート", "課題", "定期試験", "60分", "成績評価", "秀", "優", "良", "可", "不可", "GPA", "Grade Point Average", "成績確認", "不正行為", "カンニング", "学生証", "受験許可証"],
    
    "証明書": ["証明書", "学割", "発行", "学生証", "休学", "復学", "退学", "再入学", "転学部", "転学科", "卒業", "在学", "卒業見込", "在学年限", "8年", "除籍", "卒業延期", "前期末卒業", "卒業見込証明書"],
    
    "留学": ["留学", "海外", "協定校", "IEC", "国際交流", "交換留学", "半期留学", "短期海外研修", "韓国", "中国", "台湾", "タイ", "ベトナム", "アメリカ", "イギリス", "フランス", "インドネシア", "マレーシア", "ルーマニア", "ホームステイ", "UC Davis", "エセックス大学", "チェンマイ大学", "TOEIC", "単位認定", "60単位"],
    
    "学生支援": ["サークル", "部活", "ボランティア", "障がい", "障害", "データサイエンス", "AI教育プログラム", "札幌圏大学単位互換制度", "国内留学制度", "沖縄国際大学", "関東学院大学", "コーディネーター", "修学支援", "情報保障", "PCテイク", "通学介助", "別室受験", "サポートセンター", "学生支援課"],
    
    "経済支援": ["奨学金", "授業料", "学費", "免除", "支援金", "学費支援", "家計急変", "被災学生", "授業料減免"],
    
    "資格": ["資格", "免許", "講座", "キャリア", "教員免許状", "学芸員", "Teaching License", "Museum Curator", "中学", "高校", "小学校", "特別支援学校", "人文学部", "法学部", "経済経営学部", "人間科学科", "英語英米文学科", "こども発達学科", "法律学科", "経済学科", "経営学科", "社会", "英語", "地歴", "公民", "商業", "教育実習", "教職実践演習", "日商簿記検定", "実用英語技能検定"],
    
    "相談": ["相談", "カウンセリング", "悩み", "メンタル", "ハラスメント", "トラブル"],
    
    "施設": ["図書館", "購買", "場所", "どこ", "Wi-Fi", "PC", "パソコン", "教室", "体育館", "グラウンド", "駐車場", "スポーツ施設", "江別第2キャンパス", "メインアリーナ", "サブアリーナ", "上靴", "江別キャンパス", "新札幌キャンパス", "C館"],
    
    "生協": ["生協", "コープ", "教科書", "共済", "組合員", "購買", "食堂", "書籍", "パソコン", "カフェテリア", "学内ショップ", "食堂", "メニュー"],
    
    "履修": ["履修", "科目", "単位", "必修", "履修登録", "セメスター制度", "前期", "後期", "124単位", "卒業要件", "45時間", "事前学修", "事後学修", "履修登録単位数", "上限", "42単位", "48単位", "面接授業", "遠隔授業", "英語IA", "英語IB", "スポーツA", "スポーツB", "バドミントン", "バレーボール", "バスケットボール", "卓球", "教養科目", "専門科目", "Moodle", "履修登録取消制度", "抽選科目", "他大学", "既修得単位"],
    
    "連絡・提出": ["情報ポータル", "掲示", "掲示板", "メールアドレス", "提出物", "提出時間", "期限", "時刻", "レポート表紙", "学籍番号", "氏名", "時間割", "学科", "年", "ページ数", "教育支援課"]
}
